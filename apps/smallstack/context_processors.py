...
def branding(request: HttpRequest) -> dict[str, Any]:
    ...
    return {
        ...
        "smallstack_public_status_enabled": getattr(settings, "SMALLSTACK_PUBLIC_STATUS_ENABLED", True),
        "smallstack_api_enabled": getattr(settings, "SMALLSTACK_API_ENABLED", True),
        "smallstack_mcp_enabled": getattr(settings, "SMALLSTACK_MCP_ENABLED", True),
